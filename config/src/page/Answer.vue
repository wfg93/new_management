      ...
      <div v-show="od == 0">
        <div class="top">
            ...
            <div style="width:100%;height:64%;display: flex;">
              ...
              >
                <div style="display: flex;">
                  <span style="font-size: 14px;color:#b1b1b1">昨日参与</span>
                  <span
                ...
                <div style="display: flex;">
                  <span style="font-size: 14px;color:#b1b1b1"> 今日新增</span>
          ...
          <div class="dtcs">
            ...
            <div style="width:100%;height:64%;display: flex;">
              ...
              >
                <div style="display: flex;">
                  <span style="font-size: 14px;color:#b1b1b1">昨日答题</span>
                  <span
                    style="font-size: 1rem;color: #2d8aea;font-weight: bold;margin-left: 10px;"
                  >
          ...
          <div class="jltx">
            ...
            >
              <!--11111-->
              <div style="font-size: 12px;color: #999999;font-weight: bold;">
                昨日提现
        ...
        <div class="bottom">
          ...
          <div class="left-div">
            ...
            <div class="yzz">
              <div
                style="font-size: 1rem;color: #333333;margin-left: 1.81rem;padding-top: 1.5rem;font-weight: 400;"
              >
                月增长（人）
              </div>
              <div
                style="width: 255px;height:310px;"
                id="maiadf"
              ></div>
            </div>
            <!-- 季度增长 -->
        ...
        <div class="app_Download">
          ...
          <div class="a_dow">
            ...
            <div class="b_dowload" style="display:flex">
              ...
              <div style="width:49%;height: 100%; font-size:15px;">
                <div style="width:151px;margin:22% auto 0">
          ...
          <div class="a_dow">
            ...
            <div class="b_dowload" style="display:flex">
              ...
              <div style="width:49%;height: 100%; font-size:15px;">
                <div style="width:141px;margin:22% auto 0">
                  完成答题：{{APP_doLad.totalAnswer }}人
                </div>
        ...
        >
          <div style="display: flex;margin-top: 1.69rem;">
            ...
            <input
              type="text"
              v-model="q.question"
              @blur="subject('itemId'+q.uuId,q.question)"
            ...
            <div>
              ...
              >
                <input
                  ...
                  @blur="subject(q.uuId,adata.answerOption,adata.id)"
          ...
          <div style="display: flex;margin-top: 1.69rem;">
            ...
            <textarea
              ...
              @blur="subject(q.uuId,q.answerRemark)"
              type="text"
...
export default {
  ...
  methods: {
    subject(itemId,value,qid) {
      let data={
        
      }
      console.log('大题id',itemId)
      console.log('大题或者小题内容',value)
      console.log("小题id",qid);
    },
...
.cyrs {
  ...
  box-shadow: 0px 4px 8px 0px rgba(142, 142, 142, 0.17);
